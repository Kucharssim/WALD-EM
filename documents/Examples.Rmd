...
The following function in `log_integral_attention_1d.stan` implements the integral of an intensity function in one dimension multiplied by the attention window:
...
And the function in `log_integral_attention_mixture_2d.stan` implements the integration:
