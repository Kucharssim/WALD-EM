...
nu_model <- rstan::stan_model(here::here("stan", "nu_objects_central_distance_saliency_horizontal.stan"))
...
ggsave(filename = here("figures/fit_model_horizontal/joint_bf.png"), width = 10, height = 6)
...
data_combined %>%
  ...
  facet_wrap(~group)
ggsave(filename = here("figures/fit_model_horizontal/durations_scatter.png"), width = 10, height = 6)
...
data_combined_tiled %>%
  ...
  ylab(expression(log (BF[+0]))) +
  facet_wrap(~group)
ggsave(filename = here("figures/fit_model_horizontal/joint_bf_tiled.png"), width = 10, height = 6)
...
data_combined_tiled %>%
  ...
  theme(legend.position = "none") +
  facet_wrap(~group)
ggsave(filename = here("figures/fit_model_horizontal/durations_scatter_tiled.png"), width = 10, height = 6)
...
data_combined_tiled %>%
  ...
  ylab(expression(log (BF[+0]))) +
  facet_wrap(~group)
ggsave(filename = here("figures/fit_model_horizontal/durations_on_location_prob_bf.png"), width = 10, height = 6)
...
ggsave(filename = here("figures/fit_model_horizontal/durations_on_location_prob_scatter.png"), width = 10, height = 8)
