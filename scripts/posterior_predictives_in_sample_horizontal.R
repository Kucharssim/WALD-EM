...
save(posterior_predictives, file = here::here("saves", "posterior_predictives_in_sample_horizontal.Rdata"))
...
ggplot2::ggsave(filename = "fixation_durations.jpg", path = here::here("figures", "fit_model_horizontal", "in_sample"),
...
for(img in unique(df_sub$id_img)){
  ...
  # save
  ggplot2::ggsave(image_name, pp, path = here::here("figures", "fit_model_horizontal", "in_sample", "xy"),
...
ggplot2::ggsave(filename = "amplitude.jpg", path = here::here("figures", "fit_model_horizontal", "in_sample"),
                plot = p1_2, width = 8, height = 4)
...
for(img in unique(df_sub$id_img)){
  ...
  ggplot2::ggsave(filename = image_name, plot = p1_2, path = here::here("figures", "fit_model_horizontal", "in_sample", "amplitude"), 
                  width = 8, height = 5)
...
ggplot2::ggsave(filename = "angle.jpg", plot = p1, path = here::here("figures", "fit_model_horizontal", "in_sample"), 
                width = 5, height = 5)
...
for(img in unique(df_sub$id_img)){
  ...
  ggplot2::ggsave(filename = image_name, plot = p1, path = here::here("figures", "fit_model_horizontal", "in_sample", "angle"), 
                  width = 5, height = 5)
